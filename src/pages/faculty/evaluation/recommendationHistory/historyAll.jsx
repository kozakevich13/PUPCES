        ...
        <div ref={containerRef}>
          ...
          >
            <HStack>
              ...
              <Text fontSize="18px">{facultyname}</Text>
            </HStack>
            <HStack>
              <Text fontSize="20px" fontWeight="semibold">
                {" "}
            ...
            <HStack>
              ...
              <Text fontSize="18px">{validatedTotalUnits} {" "} credit unit(s)</Text>
            </HStack>
            <HStack>
              <Text fontSize="20px" fontWeight="semibold">
                {" "}
              ...
              <Text fontSize="18px">{remainingCreditUnits} {" "}credit unit(s)</Text>
            </HStack>
            <HStack>
              <Text fontSize="20px" fontWeight="semibold">
                {" "}
